...
Currently, `dySEM` facilitates the deployment of several kinds of dyadic SEMs, including:
...
`dySEM` is available both on GitHub ([repo](https://github.com/jsakaluk/dySEM); [docs](https://jsakaluk.github.io/dySEM/index.html)) and [CRAN](https://cran.r-project.org/web/packages/dySEM/index.html), and was created to simplify the process of using dyadic SEM, making it easier for researchers to leverage the power of dyadic SEMs with latent variables in their own work. 

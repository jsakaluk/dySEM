...
`dySEM` currently contains `r n_total_funcs` functions (total), of which `r n_exported_funcs` are user-facing (exported), which are covered by `r n_test_cases` unit tests (test case total).

...
The `dySEM` helps automate the process of scripting, fitting, and reporting on latent models of dyadic data via [`lavaan`](https://lavaan.ugent.be). The package was developed and used in the course of the research described in [Sakaluk, Fisher, & Kilshaw](https://psycnet.apa.org/record/2021-23304-001) (2021).
...
1. **Dyadic Exploratory Factor Analysis** ***(NEW)***
...
1. Multi-construct friendly functionality (e.g., for dyadic CFA with multiple subscales of a measure)

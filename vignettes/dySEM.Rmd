...
We now demonstrate a typical `dySEM` workflow, using the built-in [`DRES`](https://github.com/jsakaluk/dySEM/blob/master/R/DRES-data%20copy.R) data (Raposso, Impett, & Muise, 2020), in order to perform dyadic confirmatory factor analysis (CFA). More elaborate and specific vignettes are forthcoming to provide didactic materials for conducting other sorts of dyadic data analyses via `dySEM`. 
...
```{r, echo = FALSE}
    knitr::include_graphics("scripts.png", dpi = 400)
```

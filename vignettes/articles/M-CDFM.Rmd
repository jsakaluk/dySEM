...
This article is intended to serve as the primary citation of record for the `dySEM` package's functionality for fitting and interpreting the the Multiple Correlated Dyadic Factors Model with the help of the `scriptCFA()` function (and others) in `dySEM`. **If this tutorial has informed your modeling strategy (including but not limited to your use of `dySEM`), please cite this article**. 

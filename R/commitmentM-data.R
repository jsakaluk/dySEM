...
#'(Rubult, Martz, & Agnew, 1998). Data are from Sakaluk, Fisher, and Kilshaw's (in press) study
...
#' @docType data
#'
#' @usage data(commitmentM)
#'
#' @format A data frame with 282 rows and 20 variables:
#' \describe{

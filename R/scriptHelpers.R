...
multifac_lvars <- function(dvn, partner, type = "free") {
  ...
  # Use a distinct prefix ('psv') to avoid collisions with
  # latent covariance labels generated in multifac_lcovars()
  # (e.g., psi12 for the covariance between latent variables 1 and 2).
  labels <- paste0("psv", label_start:label_end)

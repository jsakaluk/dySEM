...
scriptCFA2 <- function(dvn, scaleset = "FF",
                      constr_dy_meas = c("loadings", "intercepts", "residuals"),
  ...
  if(!is.list(dvn$p1xvarnames) | !is.list(dvn$p2xvarnames)){
    stop("You must supply a dvn object from an instance of scrapeVarCross() when the var_list argument has been used (i.e., the dvn should contain indicators for multiple factors per partner")
  }

...
#' Fitting Univariate Hierarchical Dyadic Factor Models
#' 
...
scriptHier <- function(
  ...
  if(scaleset == "FF"){
    ...
    hierloads <- cfloads(dvn, lvname = lvname, type = "equated")
  ...
  if(scaleset == "MV"){
    ...
    #hierarchical means
    xmean <- cfmeans(lvname = lvname, type = "free")
    ymean <- cfmeans(lvname = lvname, type = "free")

...
#'member of a same-sex romantic dyad. Measured using the Investment Model Scale subscales
#'(Rusbult, Martz, & Agnew, 1998). Data are from analyses under review (Sakaluk, Fisher, and Kilshaw).
